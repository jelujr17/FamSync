import 'package:famsync/main.dart';
          ...
          child: Column(
            children: [
              ...
              ErrorInfo(
                title: "Opps!....",
                description:
                    "Algo salió mal con tu conexión. Por favor, inténtalo de nuevo en un momento.",
                // button: you can pass your custom button,
                // btnText: default is retry, you can pass your custom text,
                press: () {
                  if (Navigator.canPop(context)) {
                    // Si hay páginas en la pila, vuelve a la última
                    Navigator.pop(context);
                  } else {
                    // Si no hay páginas en la pila, navega a MyApp
          ...
          children: [
            ...
            button ??
                ElevatedButton(
                  ...
                  child: Text(btnText ?? "Reintentar".toUpperCase()),
                ),
            const SizedBox(height: 16),
          ],
        ),
